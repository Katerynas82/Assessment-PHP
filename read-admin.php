    ...
    <div class="bg">
      <div class="container">
        ...
        <div class="text-cont">
          <ul>
            <li>
              <h1 class="book-title"><?php echo $books['book_title']; ?></h1>
            </li>
            <li>
            ...
            <li>
              <p class="book-item"><?php echo $books['year_published']; ?>
                <?php echo $books['publisher']; ?></p>
            </li>
            <li>
              <p class="book-item" style="padding-bottom: 20px;"><?php echo $books['genre']; ?></p>
            ...
            <li>
              <p class="book-item" style="padding-right: 25px; color: rgba(161, 74, 74, 0.7); text-align: right;">Price: £ <?php echo $books['price'];
                                                                                                                            ?>
            </li>
            <li><a class="nav-btn" href="viewbooks.php">Back to admin page</a></li>
          </ul>
        </div>
      </div>
  </main>
  <footer>
    <p style="text-align: center; color: rgba(253, 232, 192, 1); padding: 10px;">&copy; 2024 Kateryna Sukovaia. All rights reserved (✿◠‿◠)</p>
  </footer>
</body>
</html>